import type {CryptoIconProps} from "../../types.ts";

export const CryptoIcon: React.FC<CryptoIconProps> = ({ size = 'md' }) => {
    const sizeClass = {
        sm: '32',
        md: '42',
        lg: '52'
    ...
    // const getSymbolSymbol = (symbol: string) => {
    //     return symbol;
    // };

    return (
        <div>
            <svg width={sizeClass[size]} height="32" viewBox="0 0 52 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clip-path="url(#clip1_2094_2289)">
                    <path d="M36 0.5C44.5604 0.5 51.5 7.43959 51.5 16C51.5 24.5604 44.5604 31.5 36 31.5C27.4396 31.5 20.5 24.5604 20.5 16C20.5 7.43959 27.4396 0.5 36 0.5Z" fill="#6CDE07" stroke="#20252B"/>
